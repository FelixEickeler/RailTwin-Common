...
_allowed_headers = {"x": TA(np.float64, TrueValue()),
                    ...
                    # => las
                    "scan_direction_flag": TA(bool, TrueValue()),
                    "edge_of_flight_line": TA(bool, TrueValue()),
                    "synthetic": TA(bool, TrueValue()),
                    "key_point": TA(bool, TrueValue()),
                    "withheld": TA(bool, TrueValue()),
